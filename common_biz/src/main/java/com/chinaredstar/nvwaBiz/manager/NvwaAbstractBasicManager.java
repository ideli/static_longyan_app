...
public class NvwaAbstractBasicManager<T extends Identified> extends NvwaAbstractManager<T> implements BasicManager<T> {
    protected Class<T> beanClass;

    public NvwaAbstractBasicManager() {
    }
...
//    }
    ...
    public NvwaAbstractBasicManager(Class<T> beanClass) {
