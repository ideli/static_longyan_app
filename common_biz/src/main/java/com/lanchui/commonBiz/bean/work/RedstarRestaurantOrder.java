...
/**
 * Created by mdc on 2016/7/8.
 */
public class RedstarRestaurantOrder implements Identified {

    public final static String NORMAL_ENUM = "normal";
    public final static String CANCEL_ENUM = "cancel";
    private int id;
