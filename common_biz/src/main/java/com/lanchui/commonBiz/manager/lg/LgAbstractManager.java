...
public abstract class LgAbstractManager<T> extends HibernateDaoSupport implements Manager {
    private static Logger logger = Logger.getLogger(LgAbstractManager.class);

    public LgAbstractManager() {
    }
