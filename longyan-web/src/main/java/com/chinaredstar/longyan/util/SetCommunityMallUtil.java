...
public class SetCommunityMallUtil implements LanchuiConstant {
    ...
    public static RedstarCommunity setCommunityMall(RedstarCommonManager redstarCommonManager, NvwaEmployee employee, RedstarCommunity community, MultiSearchBean multiSearchBean) throws ManagerException {
