...
<head>
    ...
    <link rel="stylesheet"
          href="<%=systemConfig.get("staticLongyanUrl")%>/css/iconfont.css">
    <link rel="stylesheet"
          href="<%=systemConfig.get("staticLongyanUrl")%>/css/picker.css">
    <link rel="stylesheet"
          href="<%=systemConfig.get("staticLongyanUrl")%>/css/element.css">
    <link rel="stylesheet"
          href="<%=systemConfig.get("staticLongyanUrl")%>/css/main.css">
    <link rel="stylesheet"
          href="<%=systemConfig.get("staticLongyanUrl")%>/css/demo.css">
