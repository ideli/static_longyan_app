 ...
 *房屋信息  编辑
 **/
define('js/longyan/view/member_build_edit', [
        'text!js/longyan/template/member_build_edit.tpl',
        'text!js/longyan/template/member_build_edit_list_item.tpl',
    ...
    function( MemberBuildEditTpl, MemberBuildEditListItemTpl, NoDataTpl, NoNetworkTpl, Cache, AlertUI, HeaderView, InputBox, ButtonBox, LinkBox, TipsBar, ListBox, MemberApi) {
        var tipsAlert = tipsAlert || new AlertUI();
        var view_id = '#member-build-edit-view';
        var form_id = '#member-build-edit-form';
        var LayoutView = Backbone.View.extend({
            ...
            render: function() {
                ...
                t.$el.html(tpl(MemberBuildEditTpl, {}));
                ...
                t.list_box = new ListBox({
                    ...
                    appendItem: function(data) {
                        return tpl(MemberBuildEditListItemTpl, {
                            data: data
                        });
                    },
