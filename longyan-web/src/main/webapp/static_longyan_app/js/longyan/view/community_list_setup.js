 ...
 * 首页 -> 社区列表
 **/
define('js/longyan/view/community_list_setup', [
    ...
    function(TabsBottom, CommunityListTpl, CommunityListItemTpl, NoDataTpl, NoNetworkTpl, Cache, AlertUI, HeaderView, InputBox, ButtonBox, LinkBox, TipsBar, ListBox, CommunityApi, hybrid) {
        ...
        var LayoutView = Backbone.View.extend({
            ...
            render: function() {
               ...
               var headHtm = '<div class="headHtm"><dl>' +
                    '<dd class="active">我创建的</dd>'+
                    '<dd class="skipPage">我管理的</dd>' +
                    '</dl></div>';
                ...
                t.list_box = new ListBox({
                    ...
                    loadData: function(page, handler) {
                        ...
                        tipsAlert.openLoading({
                            ...
                            //我的小区列表
                            CommunityApi.getCommunityListCreate(page, pageSize, city, name,
                                function(data) {
                                    tipsAlert.close();
                                    if (data && data.result) {
