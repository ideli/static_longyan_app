...
@Entity
@Table(name = "xiwa_redstar_attendance_log")
public class RedstarAttendanceLog implements Serializable {

    private static final long serialVersionUID = 4322812428013763816L;
    @Id
